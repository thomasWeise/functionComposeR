...
expression.simplify <- function(expr, envir) {
  ...
  # There are two special cases I found so far where this method would explode:
  # 1. if there are missing elements (this may happen if there is a `...`
  #    involved somewhere)
  # 2. if the list is actually something like a numeric vector, maybe generated by
  #    c(1, 2, 3, 4). Then, it may be "transformed" to 1(2, 3, 4), which obviously
  #    is nonsense <- THIS ONE IS TODO
